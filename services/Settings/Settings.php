...
class Settings
{
	...
	/**
	 * Arguments used to register the page
	 *
	 * @var array
	 */
	public $args;
	...
	public function init() {
		...
		foreach(($this->args['sections']??[]) as $slug => $param) {
			...
			foreach(($param['groups']??[]) as $sslug => $pparam) {
				...
				$group->collapsed( $pparam['collapsed']??false );
				$group->submit_hidden( $pparam['submit_hidden']??false );
	...
	public function settingsPage()
	{
		...
		include App::file()->template_path( 'admin/page.php' );
		// phpcs:enable
	}
	 ...
	 * @return \Netdust\Services\Settings\Section
	 */
