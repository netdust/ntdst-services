...
namespace Netdust\Services\Security\modules;
...
class Hardening
{
    ...
    public function init(): void
    {
        ...
        if ( !empty( $bool = get_option('DISABLE_LOGIN_WITH_EMAIL') ) && $bool ) {
        ...
        if ( !empty( $bool = get_option('DISABLE_LOGIN_WITH_USERNAME') ) && $bool ) {
        ...
        /*
        if ( !empty( $bool = get_option('CHECK_PASSWORDS') ) && $bool ) {
        ...
        if (  !empty( $bool = get_option('VALIDATE_PASSWORDS') ) && $bool) {
